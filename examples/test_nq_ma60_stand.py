...
def test_quality_from_stand() -> None:
    assert quality_from_stand(0.0, 1.5, 2.0, 1.0, 10.0) == (3, "A")
    assert quality_from_stand(-10.0, 0.8, 2.0, 1.0, 40.0) == (1, "B")
    assert quality_from_stand(-10.0, 0.8, 0.5, 1.0, 40.0) == (0, "C")
