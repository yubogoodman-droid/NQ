...
1. **記號**：MA7 > MA14 > MA25 多頭排列，15m **放量陽線**收盤站上 MA200（量比 ≥1.7×、離 200 ≤2%、台北 08–20 點）。
2. **進場**：記號之後連 **三根收盤都沒跌破 MA200**，第三根收完下一根開盤做多。
3. **出場**：收盤跌破 MA200，或 4 小時到期。同一檔 8 小時只算一次。

近一週大賺單的共同點（相對 501 筆未篩選）：記號均量 **2.7×**（輸家 1.9×）、亞洲／歐洲盤明顯較好（08–19 合計 +78%，21–23 合計 −72%）、真的跑得動的單 MFE 常 5%+。所以把沒量、離 200 太遠、美盤初段亂流拿掉，出場也不再用 2R／三根低點把跑動砍掉。
...
近一週（2026-08-20 → 08-27，262 檔）：**114 筆、勝率 37.7%、等權合計 +34.5%、均筆 +0.30%**。不停損純續走 2 小時勝率 63%、均 +0.84%。大賺例子：ROBO +20%、UAI +9.7%、PORTAL MFE +37%。

先看圖（114 筆每筆都有圖，黃菱形＝記號、藍圈＝第三根確認、綠三角＝進場、× ＝出場）：
