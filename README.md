...
## NQ 起漲點 · 1 分 5>10>20>30 連兩根站上 MA200

訊號只在 **1 分鐘** 上抓：**MA5>MA10>MA20>MA30**，且 **連續兩根收盤站上 MA200**。第一根站上還不進，第二根仍排列且收在 MA200 上才做多。**MA200 上頭不能再掛 MA100 或 MA120**（兩條都要在 200 下面）。盤整箱子、放量、5 分均線都不是進場條件。
...
**08-24 07:33 @ 29216.50**（07:32 第一根站上，第二根站穩後 trail +18.4）與 **08-24 11:30 @ 29130.25**（11:29 第一根，第二根 timeout +58.0）會進。

| 區間 | 筆數 | 勝率 | 加總 |
|------|------|------|------|
| 10 天 | 20 | 30.0% | −5.6 |

比第一根就進晚一根，10 天總分從 +68.8 變成 −5.6。樣本很小，回測不是保證。
