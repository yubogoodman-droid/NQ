...
停損在左峰頭頂 +8 點；目標 2R。浮盈見過 **1.6R 後鎖 1.2R**，避免瀑布走完又吐回（像 5m 08-25 19:35），也不把今日 1m 那種還在走的瀑布提早砍掉。持倉最多 120 根，不重疊。風險需 50–220 點。
...
Yahoo 1m（2026-07-30 → 08-28）：**2 筆、勝率 100%、+336 點**。  
五分 K 同一套規則對照：**9 筆、勝率 44.4%、+296 點**（8 筆卡在均線糾結被濾掉）。  
5m #7（08-25 19:35）浮盈約 140 點後原本逾時只剩 +2.2，鎖利後 **21:00 出場 +98.8**。  
今日 1m：11:38 帶寬 13 濾掉，**11:40** 進 29678，鎖利 **+169.8**。5m 同結構 **11:45** / 29634 / 逾時 **+143.5**。
