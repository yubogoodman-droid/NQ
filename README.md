...
成交額前 100、濾掉 ETF／金融股／電信股／股價 600 以上。五分 K **MA5 > MA10 > MA20 且均線發散**（不要糾結），當根收盤剛站上五分 **MA200**，收盤高於所有均線，且 **小時K收在 MA20 之上**，記一則通知。

```bash
python3 examples/backtest_tw_5m.py --days 5
```

報告：`docs/tw/backtest-5m-15m.html`（每檔一張圖，上面五分K、下面十五分K）
