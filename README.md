...
對齊手機圖藍圈：先破底，反彈**收復粉紅 MA20**，等價格離開均線後再**回踩 MA20** 才做多，不在收復當根追。

```
破底（近 2 小時低點） → 收復 MA20 → 連續 3 根低點離開均線 → 回踩 MA20 進場
停損：破底低點下方 10 點
停利：1.5R；滿 12 根若收盤跌破 MA20 出場
過濾：進場貼著下彎的 5m MA60（40 點內），或夾在下彎的 5m MA20/MA30 蓋頭底下，則略過
```

2026-08-24 實例：09:50 低點 28946.75 → 10:35 收復 → **11:00 回踩進場 29059**（藍圈起點），13:00 收破 MA20 出，約 **+100 點**。進場時 5m MA60 29157 下彎，距離 −98 點，不會被濾。

近一個月 Yahoo 5m（2026-07-21 → 08-24，RTH）：**1 筆、勝率 100%、+100 點**（只有 08-24；08-18 −14 因貼下彎 5m MA60 被濾）。  
同一套不限時段 7 筆、+198 點，夜盤雜訊較多。
...
近一個月 Yahoo 1m（2026-07-26 → 08-24，**日盤 09:30–15:45**）：**12 筆、勝率 75%、+524 點**。  
漏斗濾掉 4 筆「貼下彎 5m MA60」（08-10 −69、08-11 早盤 −50、08-19 +48、08-20 +17），淨少虧。  
08-18 10:34 那筆 −93 是買在下彎五分 MA20/MA30 蓋頭底下，也濾掉。  
08-24 同一波：09:53 破底 28946.75 → 09:58 收復 1m MA20 → **10:50 回踩進場 29094**，+74 點。當時 5m MA60 29164 下彎、距離 −70 點（>40，會留）。  
全時段含夜盤 35 筆、勝率 45.7%、+203 點，夜盤較雜，報告下面留著作研究。
