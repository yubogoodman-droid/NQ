...
4. **收盤剛從 MA240 下面（含等於）穿上**就通知

`MA240` 是一分 K 的 240 期均線（約 240 分鐘），不是日線 240 日。隔夜跳空（09:00 對昨收）不算。五分 K 只當對照圖，不拿來濾訊號。
...
4. 出現新的站上訊號立刻發 Telegram，同一根 K 不重複通知
