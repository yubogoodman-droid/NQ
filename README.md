...
五分 MA20 下跌時：追在它上方超過 35 點不進；壓在斜率比 −15 更負的蓋子下也不進
```

只做日盤 09:30–15:45 ET。1m MA20 約 20 分鐘，比 5m MA20（約 100 分鐘）更貼價格。

近一個月 Yahoo 1m（2026-07-30 → 08-28，日盤 09:30–13:00）：**9 筆、勝率 66.7%、+356.2 點**（6 勝）。  
08-03 **#1** 進在圈裡：**09:50 右肩踩 1m MA20 28470**，5m MA20 上彎走 2R **+126.5**。  
你給的 08-28 圖是 **#9**：10:13 破底 29505 → 10:27 大陰線不進 → **10:28 綠 K 確認 29627**，1.5R **+50.2**。  
08-24 同一波：11:18 進場，1.5R **+43**。  
五分 MA20 下跌時不追、不買蓋子：08-05 / 08-07 / 08-11 那種壓在陡降均線下的肩整波拿掉。
