...
## NQ 起漲點 · 1 分 5>10>20>30 站上 MA200

訊號只在 **1 分鐘** 上抓：**MA5>MA10>MA20>MA30**，且 **這一根才收盤站上 MA200**（前一根還在下方）。不要等後面那根放量長綠。盤整箱子、放量、5 分均線都不是進場條件。

停損在進場前 20 根修剪低點下方 5 點；目標 2R。走到 **1R 後停損移到 +0.3R**。連續 2 根 1 分收回到進場時 MA200 下，當成站上失敗、用收盤離場。

每筆 1 分進場會附上 **當時的 5 分 K** 只是對照：只用到進場那一分為止，不會偷看後面。
...
**為什麼舊規則會漏 11:29：** 舊版還要先通過「均線糾結盤整箱」才准進場，11:21 急殺把箱子撐破，即使 11:29 已經 5>10>20>30 且站上 MA200 也不算。現在進場就只看這兩個條件。
...
**08-24 07:32 @ 29217.75**（trail +19.1）與 **08-24 11:29 @ 29121.25**（timeout +79.5）都會抓到。拿掉箱子後訊號變多，很多是剛站上又連兩根收回 MA200 下（fail）。樣本很小，回測不是保證。
...
- `pinescript/nq_ma_coil_breakout_1m.pine` — NQ 一分 K：5>10>20>30 站上 MA200。
