...
截圖那種：15m **MA7 < MA14 < MA25**，同一根紅 K 收盤同時跌破 **MA99 與 MA120**，且進場價在 **1h MA25 下方**、還不能已經掉到 **1h MA200 下面**、與 **1h MA99 距離 ≤ 20%**、離 **1h MA120 ≥ 2%**，且 1h 的 **MA7/14/25/99/120 不能糾結**（張開 ≥ 4%），進場前 36 根 1h **不能堆 3 個前低**在進場價下方 5% 內，進場做空。  
...
近一週（2026-09-01 → 09-08 TPE）、流動 U 永續 **142 檔（已濾股票；1h MA25 下、不在 1h MA200 下、離 1h MA99 ≤ 20%、離 1h MA120 ≥ 2%、1h 五均不糾結）**：**38 筆、已平勝率 47.1%、平均 +1.85%、加總 +70.4%**。已在 1h MA200 下方的不空（濾掉 44 筆，含舊 #1 TRUMPUSDT）。  
