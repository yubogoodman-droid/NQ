...
1 分鐘圖：下跌後均線糾結、窄幅盤整，再放量突破盤整箱。進場要 **MA5>MA10>MA20>MA30 多頭排列、收盤站上 MA200，且 MA60、MA120 都在 MA200 下方**。停損在盤整低點下方；目標 2R。
...
近 10 天 Yahoo 1m（2026-08-14 → 08-24）：**11 筆、勝率 45.5%、約 +2 點**。
其中包含你那張圖的 **08-24 07:35** 起漲（29247，盤整 29172–29203，量能 7.8x）。
漏斗：盤整箱 3029 → 5/10/20/30 排列 713 → 站上 MA200 1676 → 60/120 在 200 下 1387 → 進場 11。
