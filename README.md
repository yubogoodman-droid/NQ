...
Yahoo 1m 目前約 **2026-08-05 → 09-04**。五分收盤跌破 **MA20** 提早出後約 **57 筆、勝率 29.8%、+519**（11 筆 +100，20 筆提早出）。同窗 MA21 提早出約 **+615**；完全不提早出約 **55 筆 / +1007**。每筆圖有 **5m / 15m / 1h 對照**；五分綠線是 MA20。
