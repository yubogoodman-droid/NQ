...
1 分鐘圖：跌破近兩小時低點後，**半小時內**出現 MA5>MA20 多頭排列，且 1 分 K **收盤突破 MA60**，就在當時的 MA60 掛限價買單，**只掛 5 分鐘**。回踩成交才進場；超過五分鐘沒碰到就取消。進場當下若 MA5/10/20/30 黏在一起（帶寬 < 12 點，像 08-05 11:38 那筆）就濾掉。停損在破底低點（不把停損上移到 MA60），目標 2R。
