...
截圖那種：15m **MA7 < MA14 < MA25**，同一根紅 K 收盤同時跌破 **MA99 與 MA120**，且進場價在 **1h MA25 下方**、還不能已經掉到 **1h MA200 下面**、與 **1h MA99 距離 ≤ 20%**、離 **1h MA120 ≥ 2%**，且 **15m 的 MA7/14/25/99/120 不能糾結**（張開 ≥ 1.5%），進場 K 若還在 **15m MA200 上方**則開盤須高於 200 至少 **4%**，且若 **2R 還在 15m MA200 下方**則進場 K 必須真正打到 200（缺口回補 ≥50% 或實體 ≥3%），且 1h 的 **MA7/14/25/99/120 不能糾結**（張開 ≥ 4%），進場做空。  
...
近一週（2026-09-01 → 09-08 TPE）、流動 U 永續 **141 檔（已濾股票；1h MA25 下、不在 1h MA200 下、離 1h MA99 ≤ 20%、離 1h MA120 ≥ 2%、15m 五均張開 ≥ 1.5%、15m MA200 開盤 ≥ 4% 或已跌破、2R 在 MA200 下須打到 200、1h 五均張開 ≥ 4%）**：重掃後更新。弱陰線踩在 15m MA200 上、2R 卻要打穿 200 的不空（龍蝦／NAORIS）；2R 還在 200 上面的 UNI／COTI／ZAMA 留著。  
