...
1 分鐘圖：高檔做出雙頂（兩高峰價差 ≤ 0.12%、深度 ≥ 0.15%，接近近 2 小時高點），第二頭仍高於 MA60 至少 30 點，確認後 **35 根內收盤跌破 MA60** 做空。  
停損在較高頭頂 +8 點；目標取量度跌幅與 1.5R 較近者。持倉最多 120 根，不重疊。風險需 50–220 點（對應「高峰明顯在均線上方再跌破」）。
...
Yahoo 1m（2026-07-29 → 08-28）：**38 筆、勝率 47.4%、約 +3 點**（含今日 11:36 那筆 M 頭空 +100.5）。  
只做 09:30–16:00 ET：`python3 examples/nq_m_head.py --period 30d --rth` → 14 筆、+8.5 點。
