...
近一個月 Yahoo 1m（2026-07-30 → 08-28，日盤）：**16 筆、勝率 43.8%、+241.7 點**（7 勝）。  
08-03 **#1** 進在圈裡：**09:50 右肩踩 1m MA20 28470**（不是 10:04 那腳追價）。  
你給的 08-28 圖是 **#15**：10:13 破底 29505 → **10:27 右肩踩 MA20 29614**，10:29 1.5R **+30.4**（不是 10:28 打平）。  
同一天下午 12:57 那筆已拿掉：11 點瀑布後再創新低，不算破底翻。  
