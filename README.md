...
停損在盤整低點下方 5 點；目標 2R。走到 **1R 後停損移到 +0.3R**（移動停利），後面拉回就鎖一截，2R 還在。連續 2 根 1 分收回到盤整高點下，當成突破失敗、用收盤離場。不追 1 分實體已經超過 40 點的長 K；當時 5 分若還在 5 分 MA200 下方超過 100 點，當成大空裡的反彈，不接。進場當下 **5 分收盤要在 5 分 MA20 上方**。
