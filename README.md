...
```
破底（近 2 小時低點，只算日盤） → 收復 MA20 → 離開均線 → 至少再過 30 根 → 右肩回踩 MA20 進場
右肩：相對這波反彈高點至少拉回 25 點再踩 MA20
進場收盤須貼 1m MA20（高於不超過 8 點）；影線掃到但收在均線上方 30 點那種要再等回踩
大陰線砸上 MA20：這波作廢，不買下一根
停損：右肩低點下方 10 點（不是破底）
停利：1.5R；滿 60 根若收盤跌破 MA20 出場
過濾：貼著下彎 5m MA60，或夾在下彎空頭排列的 5m MA20/MA30 蓋頭底下，則略過
```

只做日盤 09:30–15:45 ET。1m MA20 約 20 分鐘，比 5m MA20（約 100 分鐘）更貼價格。

近一個月 Yahoo 1m（2026-07-30 → 08-28，日盤）：**9 筆、勝率 11.1%、−148.4 點**（1 勝、2 筆打平、6 負）。  
你給的 08-28 圖現在是 **#8**：10:13 破底 29505 → **11:23 右肩踩 MA20 29768**（收盤只高均線 4 點），停損在右肩低點 29725，11:39 停損 **−43**。  
08-03 不再是彈走後 28572 追進去：改等回踩，**10:07 進 28551.5**（貼 MA20 28550）。  
08-24 同一波：11:18 進場，1.5R **+43**。
