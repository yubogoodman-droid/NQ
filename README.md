...
圖 29 是 11:30 兩小時低 29478 → 12:05 站上 → 13:05 跌破 → 13:45 回測 29468 → **14:00 進場**。報告分兩段：**五分K 回測** 與 **15分K 回測**（15 分的兩小時是 8 根，守三根 = 45 分鐘）。停損在回測低下方 4 點；目標取量度或 2R 較遠者。
...
TradingView：`pinescript/nq_w_ma20_5m.pine` 貼到 NQ1! / MNQ1! 五分圖；15 分圖把「兩小時 K 數」改成 8。
