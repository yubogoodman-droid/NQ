...
1 小時圖：`MA7 > MA14 > MA25 > MA99 > MA120 > MA200` 多頭排列，剛收盤那根成交量 **大於前一根一倍以上**（量 > 前一根 × 2），收盤在 MA25 上方、**離 MA25 ≤ 1.5%**，必須是 **收漲陽線**，且短均 **有點發散**（MA7/MA25 0.20%～0.80%，比 6 根前更散；長均 99/120/200 還不能炸開）。像 BNB 那種剛散開、不是黏成一條也不是已經噴飛。推 Telegram（帶圖）。同一根 K 不會重發。
