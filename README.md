...
1m 停損在左峰頭頂 +8；5m **+36**（避開 08-24 07:35 那種軋空掃損）。5m **收盤夾在 MA120 與 MA200 中間不空**（慢均還在托，只破 MA60 當假跌破）。目標 2R。虧損單多半先走過一段再吐回去，所以不整筆濾掉：5m 見過 **0.6R 先鎖進場價**（保本跑），再 0.8 / 1.2 / 1.6R；1h 沒破時收盤收回 5m MA60 出場，1h 已破就等收回 1h MA60。鎖利下一根才生效。持倉最多 120 根，不重疊。風險需 50–220 點。
...
五分 K 兩個月（2026-06-30 → 08-28）：**23 筆、13 勝 / 4 保本 / 6 虧、+1180 點**（不用時間過濾；3 筆慢均夾心被擋）。07-13 那種走過 0.6R 再吐停損改保本；07-10 −186 改收回 5m MA60 **−56**。代價：07-09、08-11 原本能賺的被 reclaim 砍成小虧。今日 1m #2：**11:40** / 29678 / 逾時 **+205.5**。
