...
截圖那種：15m **MA7 < MA14 < MA25**，同一根紅 K 收盤同時跌破 **MA99 與 MA120**，且進場價在 **1h MA25 下方**、還不能已經掉到 **1h MA200 下面**、與 **1h MA99 距離 ≤ 20%**、離 **1h MA120 ≥ 2%**，且 **15m 的 MA7/14/25/99/120 不能糾結**（張開 ≥ 1.5%），進場 K 若還在 **15m MA200 上方**則開盤須高於 200 至少 **4%**（收盤仍貼 200 且實體太小如龍蝦也不空），且 1h 的 **MA7/14/25/99/120 不能糾結**（張開 ≥ 4%），進場做空。  
