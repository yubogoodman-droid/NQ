...
16~28 根內從左側高點灌到右側低點（≥120 點 / 4 ATR），底部不盤；**頸線=起跌高，兩邊要差不多**（右腿第一次回到頸線 ≥98%，時間為左腿的 0.50~1.60 倍），收紅站上 MA5 做多。  
...
近一個月 Yahoo 五分（2026-07-26 → 08-28）：**9 筆、勝率 66.7%、+359.2 點**（均筆 +39.9）。  
