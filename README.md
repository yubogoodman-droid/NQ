...
五分 K 兩個月（2026-06-30 → 08-28）：**24 筆、勝率 79.2%、+1482 點**（不用時間過濾；3 筆慢均夾心被擋）。  
近一個月那 7 筆還在（+749）；往前一個月多 17 筆、淨 +733，裡面有 07-08 −142、07-10 −186、07-13 −153 三筆較大虧。今日 1m #2：**11:40** / 29678 / 逾時 **+205.5**。
