...
Yahoo 1m（2026-07-30 → 08-28）：**2 筆、勝率 100%、+253.5 點**。  
五分 K 同一套規則對照：**9 筆、勝率 44.4%、+199 點**（8 筆卡在均線糾結被濾掉）。  
今日 1m：H1 11:01 / H2 11:26，**11:38 帶寬 13 點濾掉**，等到 **11:40** 帶寬 34 再進 29678、逾時 **+205.5**。5m 同結構仍是 **11:45** 進場 29634、持倉到 15:45 **+143.5**。
