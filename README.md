...
成交額前 200、濾掉 ETF／金融股／電信股／股價 500 以上。五分 K **MA5 > MA10 > MA20 且往上**，當根收盤剛站上五分 **MA240**（開盤第一根跳空也算），收盤高於 MA5／10／20／240。
...
同一套掃描池與多方條件。五分／十五分剛站上 MA240 就推 Telegram，同一根 K 不重發。啟動時用永豐抓一次歷史 1 分K 當均線底，盤中改訂閱 tick 合成五分／十五分（不要盤中重覆打 kbars）。
...
python watch_tw.py            # 盤中一直盯（五分＋十五分，多方）
