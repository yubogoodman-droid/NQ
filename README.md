...
近一個月 Yahoo 1m（2026-07-30 → 08-28，日盤）：**10 筆、勝率 10%、−148.4 點**（1 勝、3 筆打平、6 負）。  
你給的 08-28 圖現在是 **#9**：10:13 破底 29505 → **11:23 右肩踩 MA20 29768**，停損在右肩低點 29725，11:39 停損 **−43**（舊版用破底停損會是 −273）。  
