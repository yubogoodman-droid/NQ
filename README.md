...
Yahoo 1m 目前約 **2026-08-05 → 09-04**。加「五分收盤跌破 MA21 提早出」後約 **57 筆、勝率 31.6%、+615**（12 筆仍打到 +100，18 筆提早出）。同窗不加這條約 **55 筆 / +1007**——提早出會切掉後面才走到 +100 的單。每筆圖有 **5m / 15m / 1h 對照**；五分圖白虛線是 MA21。
