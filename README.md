...
1m 停損在左峰頭頂 +8；5m **+36**（避開 08-24 07:35 那種軋空掃損）。5m **收盤夾在 MA120 與 MA200 中間不空**（慢均還在托，只破 MA60 當假跌破）。5m 收盤還在 **MA200 上方超過 150 點且 1h 已破才不空**（#5；#6 那種 1h 沒破加回來）；已破 MA200 但 **1h MA60 還在下面超過 200 點且 MA60 仍往上也不空**（#8 砸到 200、大週期還沒測到）。5m 持倉後多一條 STRICT **破底翻平空**（進場不變）：先破近 2 小時低，15 根內收盤收回 MA20+MA30 且 MA5>MA10>MA20；貼下彎 MA20 不平。目標 2R。鎖利下一根才生效：1m 見過 **1.6R 鎖 1.2R**；5m **0.8R 鎖 0.5R、1.2R 鎖 0.9R、1.6R 鎖 1.2R**。持倉最多 120 根，不重疊。風險需 50–220 點。
