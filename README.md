...
Yahoo 1m 目前約 **2026-08-06 → 09-04**：**62 筆、勝率 30.6%、+980**（19 筆 +100，4 筆浮盈+60後保本，其中 9 筆是停損後再進）。停損一律 MA200−10；停損後 30 分鐘內五分 K 站回 MA5/10/20/60 且 MA5>10>20 多排再進一次。每筆圖有 **5m / 15m / 1h 對照**。
...
8. 浮盈先到 +60，停損提到進場價
9. 停損後 30 分鐘內，五分 K 站回 MA5/10/20/60 且 MA5>10>20 多排，再進一次（只一次，停損同上）
