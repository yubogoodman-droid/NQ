...
Yahoo 1m 目前約 **2026-08-06 → 09-04**：**46 筆 / 勝率 39.1% / +1269**（再進 2 筆）。進場收盤必須在 MA60 上。停損為 **MA200−10**；進場在 15m MA200 上被停損後，30 分鐘內站回原進場價再進一次（再進也要距 MA200 ≤30）。五分全均帶寬 <28，或再進時五分 MA5–30 <20，視為糾結不進。每筆圖有 **5m / 15m / 1h 對照**，並附成交量與 MACD(12/26/9)。
