...
1m 停損在左峰頭頂 +8；5m **+36**（避開 08-24 07:35 那種軋空掃損）。5m **收盤夾在 MA120 與 MA200 中間不空**（慢均還在托，只破 MA60 當假跌破）。5m 收盤還在 **MA200 上方超過 150 點且 1h 已破才不空**（#5；#6 那種 1h 沒破加回來）；已破 MA200 但 **1h MA60 還在下面超過 200 點且 MA60 仍往上也不空**（#8 砸到 200、大週期還沒測到）。目標 2R。鎖利下一根才生效：1m 見過 **1.6R 鎖 1.2R**；5m **0.75R 鎖 0.5R、1.2R 鎖 0.9R、1.6R 鎖 1.2R**。持倉最多 120 根，不重疊。風險需 50–220 點。
...
Yahoo 近一個月（2026-08-05/06 → 09-04）：1m **2 筆、勝率 100%、+372.0**；5m **8 筆、7/1、勝率 87.5%、+982.0**。規則同現況（5m 停損 +36、0.75/1.2/1.6R 鎖利、無破底翻、無硬虧 60）。一小時 K 0 筆。1m #2：**11:40** / 29678 / 逾時 **+205.5**。
