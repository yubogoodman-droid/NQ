...
16~28 根內從左側高點灌到右側低點（≥120 點 / 4 ATR），底部不盤；**頸線=起跌高，兩邊要差不多**（右腿第一次回到頸線 ≥98%，時間為左腿的 0.65~1.40 倍），收紅站上 MA5 做多。  
停損右腿回撤低，目標頸線再延伸 0.7× dump。含盤外；09:30–10:00 不進。
...
近一個月 Yahoo 五分（2026-07-26 → 08-28）：**3 筆、勝率 100%、+258.6 點**，全部打到目標（1.7× dump）。  
08-27 02:10 V底 → 04:00 回到頸線進場，目標 **+86.5**（兩邊時間 0.95×）。  
1.8× 起 08-27 那筆摸不到（高點只到 +92）；60 天多一筆 06-22 停損 −110.5。
