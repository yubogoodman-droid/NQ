...
|------|------|
| L1 | 左腳波段低點 |
| L2 破底 | L1 與 L3 **之間的最低點**，必須低於 L1 至少 **0.10% 或 25 點**，之後收復 L1 |
...
| MA200 | 下彎時，進場價離 MA200 不得超過 **60 點** |
| 停損 | L3 下方 **20 點** |
| 停利 | 頸線 + (頸線 − L2) |
...
| `min_spring_points` | 25 | L2 低於 L1 的最少點數（與百分比取較嚴） |
...
| `max_dist_falling_ma200` | 60 | MA200 下彎時，進場離 MA200 的最遠點數 |
