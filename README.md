...
Yahoo 1m（2026-07-30 → 08-28）：**3 筆、勝率 66.7%、+284 點**。  
五分 K 同一套規則對照：**14 筆、勝率 57.1%、+531 點**。  
今日 1m：H1 11:01 / H2 11:26，**11:38** 進場 29733、+172.5。5m 同結構 **11:45** 進場 29634、持倉到 15:45 **+143.5**（5m MA60 較慢，進場更晚、停利更寬）。
