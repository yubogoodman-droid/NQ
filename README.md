...
Yahoo 1m 目前約 **2026-08-06 → 09-04**：**47 筆 / 勝率 38.3% / +1197**（再進 3 筆）。進場收盤必須在 MA60 上。停損為 **MA200−10**；進場在 15m MA200 上被停損後，30 分鐘內站回原進場價再進一次。五分 MA5/10/20/30/60/200 全均帶寬 <28 視為糾結，主場與再進都不進。每筆圖有 **5m / 15m / 1h 對照**，並附成交量與 MACD(12/26/9)。
