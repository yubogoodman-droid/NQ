...
進場不能是砸穿 MA20 的大陰線（07-31 09:38 那種開盤追刀）
停損：破底低點下方 10 點
...
近一個月 Yahoo 1m（2026-07-30 → 08-28，日盤）：**19 筆、勝率 47.4%、+6.1 點**（9 勝 10 負）。  
QA 17 筆 +152.1；QC 2 筆 −146。07-31 09:38 開盤大陰線砸 MA20 已濾掉。  
你給的 08-28 圖現在是 **#17**：10:13 破底 29505 → 10:18 收復 → **11:23 右肩踩 MA20 29768**，12:18 打到破底停損 −273。  
漏斗：破底 756 → 深度夠 116 → 收復 116 → 右肩回踩 19 → 進場 19（追刀 3）。  
