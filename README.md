...
|------|------|
| 週期 | 5 分 K |
| 破底 | 跌破近 48 根（約 4 小時）低點，且自該段高點跌幅 ≥ 2%；**破底那根下方不能有任何均線**（5/10/20/60/120/240） |
| 反彈視窗 | 破底後 24 根內 |
...
近一週（2026-08-18→08-25）成交額前 80、**700 以上拿掉**、均線糾結不算、破底下方不能有均線： **60 筆**、勝率 60%、合計 +51.5%。  
力成兩筆都還在（08-20 12:20、08-25 11:50 停利 +3.26%）。聯一光 08-21 那種 120/240 墊在破底底下的已拿掉。  
