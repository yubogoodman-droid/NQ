...
近一個月 Yahoo 1m（2026-07-30 → 08-28，日盤）：**10 筆、勝率 70%、+218.6 點**（7 勝 3 負）。  
QA 9 筆 +323.6；QB 1 筆 −105（08-28 09:49 早盤停損）。08-28 12:53 右肩進場樣本結束時仍持倉，未計入。  
漏斗：破底 756 → 深度夠 115 → 收復 115 → 右肩回踩 58 → 進場 11（7 筆貼下彎 5m MA60、2 筆蓋頭、35 筆非日盤）。  
08-24 同一波：09:53 破底 28946.75 → 09:58 收復 → **10:50 右肩進場 29094**，+74 點。
