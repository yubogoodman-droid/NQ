...
## 幣安美股 15m 跌破均線 Telegram

只掃股票永續（EQUITY）。找開盤 **瀑布**：隔夜貼著 15m MA200 盤整（均線帶寬≤2.5%、近 5h 振幅≤3.5%），再長陰放量摔出 MA7/14/25/99/120/200（實體≥1.2%、振幅≥2.5%、近 4h 高回撤≥2.5%、量≥1.8×）。1h 仍在近日高 5% 內，且 **MA7 < MA14 < MA25** 空頭排列。  
回測圖上 15m、下 1h 對比。預設只在美東 **09:00–10:00** 才報，週末不掃。`--all-hours` 則全時段（含週末）。
...
python3 examples/watch_binance_equity_ma_break.py --backtest --days 7 --all-hours
