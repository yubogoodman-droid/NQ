...
Yahoo 1m 目前只回 **2026-08-12 → 09-04**（8/5 那週已超出 1m 視窗）：**29 筆、勝率 37.9%、+623**（10 筆打到 +100，1 筆未平 +12）。  
第一張那種 5m 短均黏成一束（MA5–30 帶寬 < 15）濾掉；第 6 張那種五分還黏（< 17）且一分 MA5–60 也黏（< 15）也濾。  
每筆圖下面加同一段時間的 **5m 對照**（進出場對齊）。
...
8. 五分K MA5–30 帶寬 < 15，或五分仍偏窄（< 17）且一分 MA5–60 < 15，當糾結濾掉
